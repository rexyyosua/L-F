               ...
               s                   </div>
                    ...
                    <div class="col s9">
                        <table class="bordered responsive-table">
                            <span class="left flow-text blue-text text-accent-3">Daftar Barang Hilang</span>
                            <thead>
                                <tr>
                                    <div class="menu-button z-depth-4 right">
                                        <a class="waves-effect waves-light btn" href="<?=base_url('index.php/user/ml')?>">
