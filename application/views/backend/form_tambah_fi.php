...
<html>
	...
	<hr>
		<div class="row">
			...
			<div class="col-sm-10">
				<h5>Register a Found item</h5>
				
				<?= form_open_multipart('user/fi/create',['class'=>'form-horizontal']) ?>
					  ...
					  <div class="form-group">
					  	<label for="date_lost" class="col-sm-2 control-label">Tanggal Penemuan</label>
					  	<div class="col-sm-10">
