...
<html>
	...
	<hr>
		<div class="row">
			...
			<div class="col-sm-10">
				<h5>Claim a Found item</h5>
				
				<?= form_open_multipart('user/cl/create/'.$id,['class'=>'form-horizontal']) ?>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-10">
						  <textarea class="form-control" name="deskripsi"  placeholder="" value="<?=set_value('deskripsi')?>"></textarea>
						</div>
					  </div>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-10">
						  <input type="text" class="form-control" name="merek" placeholder="" value="<?=set_value('merek')?>">
						</div>
					  </div>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-10">
						  <input type="text" class="form-control" name="lokasi_lengkap" placeholder="" value="<?=set_value('lokasi_lengkap')?>">
						</div>
					  </div>

					  <div class="form-group">
					  	<label for="date_lost" class="col-sm-2 control-label">Tanggal Menemukan</label>
					  	<div class="col-sm-10">
