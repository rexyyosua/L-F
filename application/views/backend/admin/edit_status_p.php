...
if($this->input->post('is_submitted')){
	...
	$status_penerima	= $product->status_penerima;
}
?>
	...
	<div class="content">
		<header>
			<h2><h1 class="page_title">Ubah Status</h1></h2>
					...
					<?= form_open_multipart('admin/db/edit_status_penerima/'.$id,['class'=>'form-group']) ?>
					<div class="form-group">
					<div class="col-md-4">
					  <label for="sel1">Status:</label>
					  <select class="form-control" name="sp" id="sel1">
					  	<option value="sedang diproses"><?=$status_penerima?></option>
