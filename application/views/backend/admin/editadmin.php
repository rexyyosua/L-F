...
?>				
			...
			<?php include 'header-admin.php' ?>
				...
				<div class="content">
					<header>
						<h2 class="page_title">Edit Admin</h2>
					</header>
					
			<div class="content-inner">
				<div class="form-wrapper">
				<div><?=validation_errors() ?></div>
				<?= form_open_multipart('admin/db/update_adm/'.$id,['class'=>'form-horizontal']) ?>
				<div style="margin-top: 10px;">
				<div>
					<input type="text" name="name" value="<?=$nama?>" placeholder="Nama" class="lg" required/>
				</div>
			
				<div style="margin-top: 10px;">
					<input type="text" name="username" value="<?=$username?>" placeholder="Username" class="lg" required/>
				</div>
				<div style="margin-top: 10px;">
					<input type="password" name="password"  value="<?=$password?>" placeholder="Passsword" class="lg" required/>
				</div>
				<div style="margin-top: 10px;">
