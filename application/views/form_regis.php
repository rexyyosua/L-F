		...
		<div class="row">
			...
			<div class="col-sm-10">
				...
				<?= form_open_multipart('regis/create',['class'=>'form-horizontal']) ?>
					  ...
					  <div class="form-group">
						<label for="inputEmail3" class="col-sm-2 control-label">NPM/NIK</label>
						<div class="col-sm-10">
						  <input type="text" class="form-control" name="npm" placeholder="" value="<?=set_value('npm')?>">
						</div>
					  </div>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-10">
						  <input type="text" class="form-control" name="no_tlp" placeholder="" value="<?=set_value('no_tlp')?>">
						</div>
