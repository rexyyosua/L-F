                    ...
                    <div class="col s4">
                      ...
                      <div class="col s4 valign-wrapper">
                            ...
                            <li>
                                ...
                                <div class="row">
                                    <div class="col s2">
                                        <a class="waves-effect waves-light btn-large" href="<?=base_url('index.php/user/clm/konfirm/'.$a->id)?>">Konfirmasi</a>
                                    </div>
                                    <div class="col s2">
                                        <a class="waves-effect waves-light btn-large" href="<?=base_url('index.php/user/clm/tolak/'.$a->id)?>">Tolak</a>
                                    </div>
                                    <!--<div class="col s6">
