        ...
        <div class="row">
            <div class="col s12">
                <ul class="tabs tabs-fixed-width tabs-icon">
                    <li class="tab col s4 disabled"><a class="blue-text text-darken-2 button-collapse" href="#" data-activates="slide-out"><i class="material-icons icons-height left">menu</i>Profile Saya</a></li>
                    <li class="tab col s4"><a class="active" href="#found"><i class="material-icons icons-height left">label</i>Penemuan Barang</a></li>
                    <li class="tab col s4"><a href="#claim"><i class="material-icons icons-height left">label</i>Klaim Kehilangan <?php if($ntf>0){?><span class="notification-badge"><?=$ntf;?></span></a> <?php } ?></li>
                </ul>
